...
inline const char* r_class1(SEXP obj){
  if (cheapr::vec::is_object(obj)){
    return CHAR(STRING_ELT(cheapr::attr::get_attr(obj, cheapr::symbol::class_sym), 0));
  } else {
    switch(TYPEOF(obj)) {
    case CLOSXP:
    case SPECIALSXP:
...
inline SEXP init<r_posixt_t>(R_xlen_t n, bool with_na) {
  ...
  cheapr::attr::set_class(out, cls);
  cheapr::attr::set_attr(out, cheapr::symbol::make_symbol("tzone"), tz);
  YIELD(3);
  return out;
}
...
inline SEXP cast<r_logical_t>(SEXP x, SEXP y) {
  if (cheapr::internal::inherits1(x, "logical")){
    ...
    r_as_lgl = !cheapr::is_null(r_as_lgl) ? r_as_lgl : cheapr::symbol::make_symbol("as.logical");
...
inline SEXP cast<r_integer_t>(SEXP x, SEXP y) {
  if (cheapr::internal::inherits1(x, "integer")){
    ...
    r_as_int = !cheapr::is_null(r_as_int) ? r_as_int : cheapr::symbol::make_symbol("as.integer");
...
inline SEXP cast<r_double_t>(SEXP x, SEXP y) {
  if (cheapr::internal::inherits1(x, "numeric")){
    ...
    r_as_dbl = !cheapr::is_null(r_as_dbl) ? r_as_dbl : cheapr::symbol::make_symbol("as.double");
...
inline SEXP cast<r_character_t>(SEXP x, SEXP y) {
  if (cheapr::internal::inherits1(x, "character")){
    ...
    r_as_char = !cheapr::is_null(r_as_char) ? r_as_char : cheapr::symbol::make_symbol("as.character");
...
inline SEXP cast<r_complex_t>(SEXP x, SEXP y) {
  if (cheapr::internal::inherits1(x, "complex")){
    ...
    r_as_cplx = !cheapr::is_null(r_as_cplx) ? r_as_cplx : cheapr::symbol::make_symbol("as.complex");
...
inline SEXP cast<r_raw_t>(SEXP x, SEXP y) {
  if (cheapr::internal::inherits1(x, "raw")){
    ...
    r_as_raw = !cheapr::is_null(r_as_raw) ? r_as_raw : cheapr::symbol::make_symbol("as.raw");
...
inline SEXP cast<r_list_t>(SEXP x, SEXP y) {
  if (cheapr::internal::inherits1(x, "list")){
    ...
    r_as_list = !cheapr::is_null(r_as_list) ? r_as_list : cheapr::symbol::make_symbol("as.list");
...
inline SEXP cast<r_date_t>(SEXP x, SEXP y) {
  if (cheapr::internal::inherits1(x, "Date") && !cheapr::internal::inherits1(y, "Date")){
    ...
    r_as_date = !cheapr::is_null(r_as_date) ? r_as_date : cheapr::symbol::make_symbol("as.Date");
...
inline SEXP cast<r_posixt_t>(SEXP x, SEXP y) {
  if (cheapr::internal::inherits1(x, "POSIXct") && !cheapr::internal::inherits1(y, "POSIXct")){
    ...
    SEXP x_tzone = SHIELD(cheapr::attr::get_attr(x, cheapr::symbol::make_symbol("tzone")));
    SEXP out_tzone = SHIELD(cheapr::attr::get_attr(y, cheapr::symbol::make_symbol("tzone")));
    ...
    cheapr::attr::set_attr(out, cheapr::symbol::make_symbol("tzone"), out_tzone);
    YIELD(3);
    return out;
  } else if (cheapr::is_null(x) && cheapr::is_null(y)){
    ...
    r_as_posixct = !cheapr::is_null(r_as_posixct) ? r_as_posixct : cheapr::symbol::make_symbol("as.POSIXct");
